$(document).ready(function () {
    function renderCards(sortedData) {
        ...
        $.each(sortedData, function (index, animal) {
            ...
            let imageName = `images/animals/${animal.name_german}.jpeg`;
            ...
            let divBox = $(`<div class="card-wrapper">
                <div class="card-content">
                    ...
                    <img src="${imageName}" alt="${animal.name_german}" class="card-image" />
                    <div class="card-trivia" style="background-color: ${colors.secondary};">${animal.trivia_german}</div>
